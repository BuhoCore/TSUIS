                                ...
                                <tbody>
                                    @foreach ($productos as $producto)
                                        <tr>
											...
											<td>{{ $producto->categoriasproducto->nombre }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('productos.destroy',$producto->id) }}" method="POST">
                                                    ...
                                                    <a type="button" href="{{ route('productos.create') }}" class="btn btn-sm btn-warning"><i class="fa fa-fw fa-arrow-left"></i> Tal vez</a>
                                                </form>
