...
public class ReporteModelo {
    ...
    public ReporteModelo(int cantidad, String name, int clasificacion, int id, String codigo, int existenciaMinima, int existencia, int consumo, int pedidoProveedor) {
    }
